...
import 'package:pharmaaccess/pages/cardio_module/orthopaedic_indices/rheumatoid_arthritis/RheumatoidArthritisBrain.dart';
...
class RheumatoidArthritisClassificationPage extends StatefulWidget {
  const RheumatoidArthritisClassificationPage({Key? key}) : super(key: key);

  @override
  _RheumatoidArthritisClassificationPageState createState() =>
      _RheumatoidArthritisClassificationPageState();
}

class _RheumatoidArthritisClassificationPageState
    extends State<RheumatoidArthritisClassificationPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(TITLE_ACR_EULAR_RHEUMATOID_ARTHRITIS_CLASSIFICATION),
      ),
      body: Container(
        child: Column(
          children: [
              ...
              child: StreamBuilder<bool>(
                  ...
                  builder: (_, snapshot) {
                    if (snapshot.data!) {
                      ...
                      return RheumatoidArthritisFormWidget(
  ...
  setResult(int _result) {
    RheumatoidArthritisBrain brain = RheumatoidArthritisBrain(_result);
    brain.calculate();
    result = _result;
