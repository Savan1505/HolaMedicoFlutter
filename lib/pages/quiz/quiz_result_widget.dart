...
class QuizResultWidget extends StatelessWidget {
  ...
  QuizResultWidget({Key? key, this.correctAnswer, this.givenAnswer, this.answerDescription}) : super(key: key);
      ...
      child: Scaffold(
        body: Center(
          child: ListView(
            ...
            children: <Widget>[
              Divider(height: 40, color: Color(0x00FFFFFF),),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 72),
                child: isCorrect ? Icon(Icons.check,size: 128,) : Icon(Icons.clear,size: 128,)//Image.asset("assets/images/quiz_result.png", width: 180),
              ),
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                                      ...
                                      TextSpan(
                                        ...
                                        recognizer: TapGestureRecognizer()
                                          ..onTap = () {
                                            ...
                                            Navigator.of(context).pushNamedAndRemoveUntil('/',(Route<dynamic> route) => false,arguments: 'quiz');
                                          }
                                      ),
                                      TextSpan(
                    ...
                    Row(children: <Widget>[
                      ...
                      Flexible(child: Text(answerDescription!, style: TextStyle(fontSize: 16, color: bodyTextColor)))
                    ],),
                    ...
                    Row(children: <Widget>[
                      ...
                      Flexible(child: Text(givenAnswer == null ? 'Timed Out (Your Answer)': '$givenAnswer (Your Answer)', style: TextStyle(fontSize: 16, color: bodyTextColor)))
                    ],),
